...
extension ViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "\(ItemCell.self)", for: indexPath) as? ItemCell {
            ...
            cell.setupCell(entity: TopEntity(rank: 2, title: "Imaizumin Chi wa Douyara Gal no Tamariba ni Natteru Rashii", url: "https://myanimelist.net/manga/124483/Imaizumin_Chi_wa_Douyara_Gal_no_Tamariba_ni_Natteru_Rashii", imageURL: "https://cdn.myanimelist.net/images/manga/1/242797.jpg?s=71736414410e4600ca16d063fb9e67e1", type: .doujinshi, startDate: "Aug 2019", endDate: nil, isFavorite: true))
